...
export function activate(context: ExtensionContext): void {
    const runtime = createMcpCommandRuntime(
    ...
    context.register(
        ...
        async (argv, invocation) =>
            await executeMcpCommand(runtime, argv, invocation),
    );
    context.register(
        modelCommands,
        "mcp",
        async (argv, invocation) =>
            await executeMcpModelCommand(runtime, argv, invocation),
    );
}
