...
export {
    executeSkillModelCommand,
    SKILL_MODEL_USAGE,
} from "./SkillModelCommand.js";
...
export function activate(context: ExtensionContext): void {
    context.register(
        ...
        async (argv, invocation) =>
            await executeSkillCommand(context, argv, invocation),
    );
    context.register(
        modelCommands,
        "skill",
        async (argv, invocation) =>
            await executeSkillModelCommand(context, argv, invocation),
    );
}
