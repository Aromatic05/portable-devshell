...
```bash
PORTABLE_DEVSHELL_VERSION=0.4.1 sh install-release.sh
```
...
```bash
PORTABLE_DEVSHELL_RELEASE_BASE_URL=https://mirror.example.com/portable-devshell/v0.4.1 sh install-release.sh
```
