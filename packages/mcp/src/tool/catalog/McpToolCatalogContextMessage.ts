...
export class McpToolCatalogContextMessage {
    list(): ToolDefinition[] {
        return [
            {
                description:
                    "Read user messages queued for this exact MCP context. A successful read marks returned messages delivered. Call this when the user indicates that guidance was sent from the DevShell TUI.",
                group: "context",
                inputSchema: {
