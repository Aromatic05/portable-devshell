const MCP_WORKER_TOOL_DESCRIPTIONS = new Map<string, string>([
    ...
    ["todo_report", "Send a user-visible message without ending the turn or changing Todo state. Reply to new user comments first. Otherwise report only meaningful new progress, blockers, or stage completion. Never repeat reports; if rate-limited, continue useful work instead."],
