...
export function createTransportId(
    source: TransportIdCrypto | null | undefined = globalThis.crypto,
): string {
    ...
    if (
        ...
        throw new Error(
            "A cryptographically secure random source is required to create transport IDs.",
        );
    }
