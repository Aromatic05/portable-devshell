...
const crossToolHints: Record<string, string> = {
    ...
    [errorCodes.mcpContextExpired]: "Call environ_info to create a fresh environment context.",
    [errorCodes.mcpContextInvalid]: "Do not guess or substitute another environment context; ask the user before creating one.",
