...
const crossToolHints: Record<string, string> = {
    ...
    [errorCodes.mcpContextExpired]: "Call context_renew and reuse the same ctxId.",
    [errorCodes.mcpContextDisabled]: "Call context_acquire to bind a new active Context; disabled ctxId values cannot be renewed.",
    [errorCodes.mcpContextInvalid]: "Call context_acquire to resolve or create a Context; do not guess a ctxId.",
