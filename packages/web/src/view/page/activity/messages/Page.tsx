...
export function Messages({
    ...
    }, [allBaseSessions, conversationPreferences, legacyMigrationPending, state.conversationPreferences]);
    ...
    return <section className="messages-page">
        <ConversationSidebar
            ...
            preferencesAvailable={state.conversationPreferences !== undefined}
            route={route}
        ...
        <div className="messages-content">
            ...
            {route.view === "contexts" ? <div className="messages-placeholder">
                ...
                <ConversationHistory entries={entries} threadKey={threadKey!} />
