...
export function renderReverseDeviceCode(
    result: ReverseDeviceCodeResult,
): string {
    return [
...
export function renderReverseTokenRotation(result: {
    deviceToken: string;
    instance: string;
}): string {
    return [
...
export function renderReverseTokenRevocation(result: {
    instance: string;
    revoked: true;
}): string {
