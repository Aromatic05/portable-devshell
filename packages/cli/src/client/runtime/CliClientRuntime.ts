...
export function createCliClientRuntime(connection: ClientConnection) {
    ...
    return {
        ...
        subscribe: async (instance: string, fromSeq: number): Promise<CliClientEventStream> =>
            createCliClientEventStream(instance, await runtime.openStream(instance, "subscribe", { fromSeq })),
        start: async (instance: string, relay?: CliClientRuntimeTerminalRelay): Promise<InstanceSnapshot> => {
...
export type CliClientRuntime = ReturnType<typeof createCliClientRuntime>;
