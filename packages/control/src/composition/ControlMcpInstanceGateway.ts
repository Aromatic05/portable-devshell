...
import type { InstanceCreateCoordinator } from "./InstanceCreateCoordinator.js";
...
export interface ControlMcpInstanceGatewayOptions {
    createService: InstanceCreateCoordinator;
    getConfig: () => ControlConfig;
    instanceRegistry: InstanceRegistry;
}

export class ControlMcpInstanceGateway implements McpInstanceGateway {
    readonly #createService: InstanceCreateCoordinator;
    readonly #getConfig: () => ControlConfig;
    readonly #instanceRegistry: InstanceRegistry;

    constructor(options: ControlMcpInstanceGatewayOptions) {
