...
import type { CliExtensionCommandProvider } from "../../cli/CliExtensionCommandProvider.js";
...
export function createArtifactCliCommandProvider(port: ArtifactCliCommandPort): CliExtensionCommandProvider {
    return Object.freeze({
        binding: async (argv: readonly string[], invocation: CliCommandInvocationContext) =>
            await executeArtifactCommand(argv, port, invocation),
