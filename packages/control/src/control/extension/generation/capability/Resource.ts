import type { ExtensionArtifactCapability, ExtensionArtifactShareInput, ExtensionArtifactShareRecord, ExtensionArtifactShareRevokeResult, ExtensionArtifactSource, ExtensionArtifactTarget, ExtensionArtifactTransferInput, ExtensionArtifactTransferRecord, ExtensionArtifactTransferResult } from "@portable-devshell/extension/artifact";
import type { ArtifactShareInput, ArtifactShareResult, ArtifactSourceDescriptor, ArtifactTargetDescriptor, ArtifactTransferRecord, ArtifactTransferResult, ArtifactTransferStartInput } from "@portable-devshell/shared";
import type { ArtifactService } from "../../../artifact/Service.js";
import { constants } from "node:fs";
import { createHash, randomUUID } from "node:crypto";
import { lstat, mkdir, open, readdir, rename, rm } from "node:fs/promises";
import { isAbsolute, join } from "node:path";
import type { ExtensionAssetBundle, ExtensionAssetCapability, ExtensionAssetProjectionInput, ExtensionAssetProjectionResult } from "@portable-devshell/extension";
import { createArtifactDirectoryArchive, extractArtifactDirectoryArchive } from "../../../artifact/host/storage/Archive.js";
