...
export interface ControlWebSocketChannelOptions {
    deadConnectionMs?: number;
    heartbeatIntervalMs?: number;
    now?: () => number;
}

export class ControlWebSocketChannel implements Channel {
    ...
    constructor(socket: WebSocket, options: ControlWebSocketChannelOptions = {}) {
        this.#socket = socket;
