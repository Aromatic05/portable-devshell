...
export interface ArtifactActivityDetailLine {
    disabled?: boolean;
    id: string;
    text: string;
...
export interface ArtifactActivityView {
    detailLines: Array<string | ArtifactActivityDetailLine>;
    summary: string;
}
...
export function buildArtifactActivityView(
    ...
    const detailLines: Array<string | ArtifactActivityDetailLine> = ["Artifact activity"];
