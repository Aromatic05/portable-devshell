...
import type { CommandDispatcherAudit } from "./CommandDispatcherAudit.js";
import type { CommandDispatcherEditor } from "./CommandDispatcherEditor.js";
import type { CommandDispatcherFocus } from "./CommandDispatcherFocus.js";

interface CommandDispatcherDetailOptions {
    audit: CommandDispatcherAudit;
    dispatch(intent: TuiUiIntent): Promise<boolean>;
    editor: CommandDispatcherEditor;
    focus: CommandDispatcherFocus;
    onOAuthApprovalDecision(approvalId: string, decision: "approve" | "deny"): Promise<void>;
    store: TuiAppStore;
}

export class CommandDispatcherDetail {
