...
import type { TuiBoxLine } from "../../state/Ui.js";
...
export function secretFieldLine(
    id: string,
    label: string,
    value: JsonValue | undefined,
): EditableLine {
...
export function secretRecordFieldLine(
    id: string,
    label: string,
    value: JsonValue | undefined,
): EditableLine {
...
export function buttonLine(
    ...
    label: string,
    disabled = false,
): { disabled?: boolean; id: string; text: string; tone: "accent" | "muted" } {
    return {
