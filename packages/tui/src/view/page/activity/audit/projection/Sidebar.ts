...
import { projectAuditContexts } from "./Context.js";
...
export function selectTuiAuditSidebarEntries(
    ...
    const contexts =
        instance === undefined ? [] : projectAuditContexts(state, instance);
