...
import { compactSummary, formatField, makeBox } from "./PageBoxSupport.js";
...
function summaryStatus(todo: TodoReadResult): ExpandableBoxStatus {
...
function itemStatus(status: TodoItem["status"]): ExpandableBoxStatus {
    switch (status) {
        case "in_progress":
            return "running";
        case "completed":
