...
export class TuiClientRuntimeStream {
    ...
    async nextMessage(): Promise<TuiClientRuntimeStreamMessage> {
...
export function createTuiClientRuntimeStream(instance: string, opened: OpenedClientStream): TuiClientRuntimeStream {
    return new TuiClientRuntimeStream(
        opened.stream,
