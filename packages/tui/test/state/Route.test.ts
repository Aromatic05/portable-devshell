...
import { currentTuiRoute, selectBreadcrumbSegments, selectFooterShortcuts, selectMainScreenModel, selectMainScrollKey, TuiAppStore, TuiCommandDispatcherNavigation, tuiViewProjection, type TuiCommandDispatcherFocus, type TuiFocusManager } from "../../src/testing.ts";
