...
import { asInstanceName, PrefixRoute, type JsonValue, type PrefixRouteSnapshot, type ToolCallRecord } from "@portable-devshell/shared";
...
import { currentTuiRoute, currentTuiRouteScrollKey, readContextConversationDraft, selectSidebarModel } from "../../../src/testing.ts";
                ...
                },
                {
                    ...
                    operations: [{
                        ...
                        handle: () => [{
                            ...
                            instance: "alpha",
                            lastAccessedAt: "2026-08-03T00:05:00.000Z",
