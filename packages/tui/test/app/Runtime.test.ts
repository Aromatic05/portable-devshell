...
import { currentTuiRoute, topTuiOverlay, TuiTerminalSession, type TuiTerminalPty } from "../../src/testing.ts";
import { buildTuiHitRegions, buildTuiTerminalViewportRegion, hitTargetAt, tuiScreenSelectionColumnBounds } from "../../src/view/projection/HitRegion.ts";
import { selectMainScreenModel, selectMainScrollKey } from "../../src/view/projection/View.ts";
