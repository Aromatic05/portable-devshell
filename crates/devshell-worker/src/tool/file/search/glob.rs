...
use crate::tool::file::search::{DiscoveredEntry, DiscoveryCursor};
...
impl ToolHandler for FileGlobTool {
    ...
    fn catalog_entry(&self) -> ToolCatalogEntry {
        crate::tool::contract::catalog_entry::<FileGlobInput, FileGlobOutput>(
            &self.name,
    ...
    fn call(&self, call: ToolCall) -> Result<serde_json::Value, ToolError> {
        ...
        crate::tool::contract::serialize(FileGlobOutput {
            entries,
            next_cursor,
        })
    }
