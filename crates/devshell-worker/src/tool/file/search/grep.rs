...
use crate::instance::sandbox::path::ResolvedPath;
use crate::tool::file::FileToolState;
use crate::tool::file::model::{FileGrepFile, FileGrepInput, FileGrepOutput, SearchSyntax};
use crate::tool::file::resolve_existing;
use crate::tool::file::search::DiscoveryCursor;
...
impl ToolHandler for FileGrepTool {
    ...
    fn catalog_entry(&self) -> ToolCatalogEntry {
        crate::tool::contract::catalog_entry::<FileGrepInput, FileGrepOutput>(
            &self.name,
    ...
    fn call(&self, call: ToolCall) -> Result<serde_json::Value, ToolError> {
        ...
        crate::tool::contract::serialize(FileGrepOutput {
            files: returned,
            next_cursor,
        })
    }
