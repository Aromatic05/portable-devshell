...
pub struct FileToolState {
    pub glob_cursors: Mutex<state::CursorStore<search::glob::GlobContinuation>>,
    pub grep_cursors: Mutex<state::CursorStore<search::grep::GrepContinuation>>,
...
impl FileToolState {
    pub fn new() -> Arc<Self> {
        Arc::new(Self {
            glob_cursors: Mutex::new(state::CursorStore::default()),
            grep_cursors: Mutex::new(state::CursorStore::default()),
