...
export async function runTestspacePiStandaloneSmoke({ home, workspace, reverseWorkspace }) {
    ...
    const runtimeWorkspace = join(home, ".devshell", "pi", "workspaces", "testspace-smoke");
    ...
    try {
        ...
        await rm(runtimeWorkspace, { force: true, recursive: true });
        ...
        const created = await pi.createAgentSession({
            ...
            cwd: runtimeWorkspace,
            resourceLoader,
            sessionManager: pi.SessionManager.inMemory(runtimeWorkspace),
            settingsManager,
        });
        ...
        await Promise.all([
            ...
            rm(runtimeWorkspace, { force: true, recursive: true }),
